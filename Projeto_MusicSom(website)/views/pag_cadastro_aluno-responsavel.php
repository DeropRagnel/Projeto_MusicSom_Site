...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../public/css/style_cadaluno-resp.css">
...
<body>
	...
	<div class="container-formulario">
		...
		<div class="formulario">
			...
			<div class="form-header">
				<h1>Registre do Responsável</h1>
			</div>
			
			<form id="form-resp" action="../routes/cadastro-aluno-responsavel.php" method="POST">
				
				<input type="text" required name="input_nome-resp" placeholder="Nome Completo:">

				<input type="email" required name="input_email-resp" placeholder="Email:">

				<input type="text" required name="input_tel-resp" id="phone-resp" placeholder="Telefone:">
			...
			<div class="form-header">
				...
				<input type="text" required name="input_tel" id="phone-aluno" placeholder="Telefone:">
	...
	<script>
		$("#phone-resp").inputmask({"mask": "(99) 9 9999-9999"});
		$("#phone-aluno").inputmask({"mask": "(99) 9 9999-9999"});
